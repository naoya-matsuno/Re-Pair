...
OutputData::OutputData(const std::string &output_file_name, const std::string &output_file_extension, const std::string &directory_path, const std::string &delimiter_string) {
...
// delimiter_stringを変更
void OutputData::set_delimiter_string(const std::string &delimiter_string) {
    this->delimiter_string = delimiter_string;
}
